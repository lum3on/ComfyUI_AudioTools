...
class TextToSpeechNode:
    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                "text": ("STRING", {"multiline": True, "default": "Hello, this is a test of the text to speech node."}),
                "voice_index": (voice_names, ),
                "rate": ("INT", {"default": 175, "min": 50, "max": 350, "step": 5, "tooltip": "Words per minute"}),
